...
const SEO_CONFIG: Record<string, {
  ...
  'narashchivanie-resnic': {
    ...
    description: 'Профессиональное наращивание ресниц в Нижнем Новгороде. Классика, объём 2D–5D, Голливуд. Ул. Головнина, д.35. Запись онлайн.',
  ...
  'oformlenie-brovey': {
    ...
    description: 'Коррекция и окрашивание бровей хной и краской, долговременная укладка, БОТОКС. Нижний Новгород, ул. Головнина, д.35. Запись онлайн.',
  ...
  'makiyazh': {
    ...
    description: 'Свадебный, вечерний, дневной и яркий макияж. Мастер-визажист в Нижнем Новгороде. Ул. Головнина, д.35. Запись онлайн.',
